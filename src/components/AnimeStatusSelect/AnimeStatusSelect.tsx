...
const statusOptions: UserAnimeStatusOptions = [
    ...
    {
        value: AnimeInListStatus.PLAN_TO_WATCH,
        label: AnimeInListStatus.PLAN_TO_WATCH,
    },
...
const AnimeStatusSelect: FC<AnimeStatusSelectProps> = ({
    anime,
    userAnimeListItem,
    user,
    ...props
}) => {
    const [deleteAnimeFromList, {}] =
    ...
    const animeToStatusListHandler = async (
        newStatus: SingleValue<UserAnimeStatusOption>,
        action: ActionMeta<UserAnimeStatusOption>
    ) => {
    ...
    return (
        <Select
            ...
            onChange={(newValue, actionMeta) =>
                animeToStatusListHandler(newValue, actionMeta)
            }
            defaultValue={
                userAnimeListItem &&
                ({
