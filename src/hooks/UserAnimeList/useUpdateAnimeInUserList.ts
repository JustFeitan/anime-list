...
export const useUpdateAnimeInUserList = () => {
    const [updateAnimeInList, updateAnimeInListMutation] = userAnimeApi.useUpdateAnimeInUserListMutation();
    const updateAnimeInUserList = async (newUserAnimeListItem: UserAnimeListItem) => {
