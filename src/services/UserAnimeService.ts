...
export const userAnimeApi = animeAPI.injectEndpoints({
    endpoints: build => ({
        ...
        getAnimeStatusForUser: build.query<UserAnimeListItem | null, Pick<UserAnimeListItem, 'userId' | 'animeId'>>({
        ...
        addAnimeToStatusList: build.mutation<UserAnimeListItem, UserAnimeListItem>({
        ...
        updateAnimeInUserList: build.mutation<UserAnimeListItem, UserAnimeListItem>({
